...
import com.dealspot.network.core_cognito.AWSException
import com.dealspot.network.core_cognito.AccessToken
import com.dealspot.network.core_cognito.AssociateSoftwareToken
import com.dealspot.network.core_cognito.AssociateSoftwareTokenResponse
import com.dealspot.network.core_cognito.Authentication
import com.dealspot.network.core_cognito.ChangePassword
import com.dealspot.network.core_cognito.ConfirmForgotPassword
import com.dealspot.network.core_cognito.ConfirmSignUp
import com.dealspot.network.core_cognito.Engine
import com.dealspot.network.core_cognito.ForgotPassword
import com.dealspot.network.core_cognito.ForgotPasswordResponse
import com.dealspot.network.core_cognito.GetAttributeVerificationCodeResponse
import com.dealspot.network.core_cognito.GetUserAttributeVerificationCode
import com.dealspot.network.core_cognito.GetUserResponse
import com.dealspot.network.core_cognito.Header
import com.dealspot.network.core_cognito.IdentityProvider
import com.dealspot.network.core_cognito.IdentityProviderException
import com.dealspot.network.core_cognito.MfaSettings
import com.dealspot.network.core_cognito.Refresh
import com.dealspot.network.core_cognito.Request
import com.dealspot.network.core_cognito.RequestError
import com.dealspot.network.core_cognito.ResendConfirmationCode
import com.dealspot.network.core_cognito.ResendConfirmationCodeResponse
import com.dealspot.network.core_cognito.RespondToAuthChallenge
import com.dealspot.network.core_cognito.Result
import com.dealspot.network.core_cognito.RevokeToken
import com.dealspot.network.core_cognito.SetUserMFAPreference
import com.dealspot.network.core_cognito.SignIn
import com.dealspot.network.core_cognito.SignInResponse
import com.dealspot.network.core_cognito.SignUp
import com.dealspot.network.core_cognito.SignUpResponse
import com.dealspot.network.core_cognito.UpdateUserAttributes
import com.dealspot.network.core_cognito.UpdateUserAttributesResponse
import com.dealspot.network.core_cognito.UserAttribute
import com.dealspot.network.core_cognito.VerifySoftwareToken
import com.dealspot.network.core_cognito.VerifySoftwareTokenResponse
import com.dealspot.network.core_cognito.VerifyUserAttribute
